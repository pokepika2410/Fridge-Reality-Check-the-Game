...
define config.name = _("StopWaste Fridge Reality Check the Game")
...
define build.name = "StopWasteFridgeRealityChecktheGame"
...
define config.save_directory = "StopWasteFridgeRealityChecktheGame-1634188070"
